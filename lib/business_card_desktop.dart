...
class BusinessCardDesktop extends StatefulWidget {
  const BusinessCardDesktop({super.key});

  @override
  State<BusinessCardDesktop> createState() => _BusinessCardDesktopState();
}

class _BusinessCardDesktopState extends State<BusinessCardDesktop> {
